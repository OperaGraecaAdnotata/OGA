...
<td>Find all verbs in the 3th Book of Homer's Iliad. Note that "_ident_" is
...
the 1st or 2nd half of the fist century BCE (note that <code>#3</code> refers to `pos="n"` and
`#2` to `mood="i"`)</td>
</tr>
</tbody>
</table>
